...
import { collection, addDoc, updateDoc, doc, deleteDoc, onSnapshot } from 'firebase/firestore'; // Importar deleteDoc
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr v-for="todo in todos" :key="todo.id">
                    ...
                    <td>{{ todo.estado }}</td>
                    <td>
                        <button @click="deleteTask(todo.id)" class="btn btn-danger btn-sm">Eliminar</button>
                    </td>
                </tr>
            </tbody>
        </table>
